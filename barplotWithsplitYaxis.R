# http://sickel.net/blogg/wp-content/2010/02/barplot.txt
# http://sickel.net/blogg/?p=688
...
lowspan=c(0,11) ## Plotting the lower range in the lower 11/21 of the plot.
topspan=c(lowspan[2]+1,21) ## Plotting the upper range in the upper 9/21 of the plot, 1/21 left to
# the split.
